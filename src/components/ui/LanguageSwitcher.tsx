    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="absolute right-0 top-full mt-2 z-50 min-w-50 bg-surface border border-line text-ink rounded-lg shadow-lg overflow-hidden">
            <div className="p-2">
              <div className="px-3 py-2 text-xs font-semibold text-ink-faint uppercase tracking-wider">
                {t('language')}
              </div>
